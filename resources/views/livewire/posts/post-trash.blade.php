                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-300px sorting_disabled" rowspan="1" colspan="1"
                            ...
                            @foreach($posts as $post)
                                <tr class="odd">
                                    <td>
                                        <img src="{{ $post->image_url }}" alt="{{ $post->name }}" width="70" height="50" style="object-fit: cover">
                                    </td>
                                    ...
                                    <td class="text-end">
                                        @can('restore', $post)
                                        <button wire:click="restore({{$post->id}})" type="button" class="btn btn-primary active" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
                                        ...
                                        <button wire:click="$emit('triggerDelete',{{ $post->id }})" type="button" class="btn btn-danger">
                        ...
                        <div class="py-5{{ $posts->total() == 0 ? 'd-none' : '' }}">
                            {{ $posts->links() }}
                        </div>
                    </div>
                </div>
