<x-show-modal tabindex="-1" id="kt_modal_2" request="update" title="Edit Category">
            ...
            <div class="fv-row mb-7 fv-plugins-icon-container">
                ...
                <div class="image-input image-input-empty" data-kt-image-input="true"
                     style="background-image: url({{ $this->forEditImage !== null ? $this->forEditImage : '/images/placeholder.png' }})">
                    <!--begin::Image preview wrapper-->
                    <div id="image_change" class="image-input-wrapper w-125px h-125px"
                         @if($image != null) style="background-image: url({{ $image->temporaryUrl() }})" @endif ></div>
            ...
            <div class="fv-row mb-7 fv-plugins-icon-container">
                ...
                <div class="form-check form-switch form-check-custom form-check-solid">
                    <input type="checkbox" wire:model="status" name="status" class="form-check-input w-50px" value=""
                           id="flexSwitchChecked" checked/>
                </div>
