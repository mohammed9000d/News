                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                            ...
                            @foreach($roles as $role)
                                <tr class="odd">
                                    ...
                                    <td class="text-end">
                                        @can('update', $role)
                                        <button wire:click="edit({{$role->id}})" type="button" class="btn btn-primary active" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
                                        ...
                                        @endcan
                                        @can('delete', $role)
                                        <button wire:click="$emit('triggerDelete',{{ $role->id }})" type="button" class="btn btn-danger">
